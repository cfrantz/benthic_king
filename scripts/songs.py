...
def hack(config, edit, asm):
    songs = Song.read_all_songs(edit)

    Song.commit(edit, PALACE_SONG_TABLE, [
            PALACE_INTRO,
            PALACE_THEME,
            BOSS_THEME,
    ...
    Song.commit(edit, GP_SONG_TABLE, [
    ...
    edit.write_bytes(PyAddress.prg(6, 0x9d34), bytes([0xa8, 0x9d]))

    # Pulse 1 timbre
    edit.write_bytes(PyAddress.prg(6, 0x9135), bytes([
    ...
    # Pulse 2 timbre
    edit.write_bytes(PyAddress.prg(6, 0x9da8), bytes([
